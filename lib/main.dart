    ...
    return ChangeNotifierProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData(
          useMaterial3: true,
          colorScheme:
              ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 67, 132, 69)),
        ),
        home: MyHomePage(),
      ),
    );
  ...
  Widget build(BuildContext context) {
    ...
    return Center(
      child: Column(
        ...
        children: [
          WordPairDecoration(RandomPairOfWordsGenerated: pair),
          SizedBox(height: 10),
          Row(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text('A random idea:'),
            WordPairDecoration(
                RandomPairOfWordsGenerated: pairOfWordsGenerated),
            SizedBox(
              height: 10,
            ),
            Row(
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Text(
          ...
          style: thexttheme,
          semanticsLabel:
              "${RandomPairOfWordsGenerated.first} ${RandomPairOfWordsGenerated.second}",
        ),
      ),
    );
  }
